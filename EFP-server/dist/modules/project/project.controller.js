...
const getList_project_dto_1 = require("./dto/getList-project.dto");
let ProjectController = class ProjectController {
    ...
    async findUnassignedEmployees(id) {
...
], ProjectController.prototype, "getTotalEmployee", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [getList_project_dto_1.GetProjectParams]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:paramtypes", [getList_project_dto_1.GetProjectParams]),
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "getProjectDeleted", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, common_1.Get)(':id/unassigned'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "findUnassignedEmployees", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
